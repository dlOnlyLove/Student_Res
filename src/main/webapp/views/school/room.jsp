            ...
            <div class="page-header">
                <div class="pull-left">
                    <ol class="breadcrumb visible-sm visible-md visible-lg">
                        ...
                        <li class="active"><i class="fa fa-laptop"></i>院系管理</li>
                        <li class="active"><i class="fa fa-laptop"></i>班级管理</li>
                    </ol>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default bk-bg-white">
                            <div class="panel-heading bk-bg-white">
                                <h6><i class="fa fa-table red"></i><span class="break"></span>班级管理</h6>
                            </div>
...
<!-- 班级学生详情 -->
<div class="row mfp-hide white-popup-block" id="room-more">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-default bk-bg-white">
                <div class="panel-heading bk-bg-white">
                    <h6><span class="break"></span>寝室详情</h6>
                </div>
                <div class="panel-body">
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <button id="more-close" class="btn btn-info">确认</button>
                        </div>
                    </div>
                </div>
            </div>
