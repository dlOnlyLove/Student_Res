                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default bk-bg-white">
                            <div class="panel-heading bk-bg-white">
                                <h6><i class="fa fa-table red"></i><span class="break"></span>学生信息</h6>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="bk-margin-bottom-10">
                                            ...
                                            <button class="btn btn-info" onclick="inputExcel()">导入&nbsp;<i class="fa fa-sign-in"></i></button>
                                            <a id="excel"><button class="btn btn-info" onclick= "printExcel()">导出&nbsp;<i class="fa fa-sign-out"></i></button></a>
                                        </div>
        ...
        <div class="panel-footer">
            <div class="row">
                <div class="col-md-12 text-right">
                    <button id="dialogConfirm" class="btn btn-info modal-confirm">确定</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="${pageContext.request.contextPath }/school/fileUpload" enctype="multipart/form-data" method="POST">
...
<!-- Pages JS -->
<script src="../../js/pages/schoolinandout.js"></script>
