                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default bk-bg-white">
                            <div class="panel-heading bk-bg-white">
                                <h6><i class="fa fa-table red"></i><span class="break"></span>信息预览</h6>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="bk-margin-bottom-10">
                                            <a href="${pageContext.request.contextPath}repeatInfo"><button class="btn btn-info">确认导入&nbsp;<i class="fa fa-plus"></i></button></a>
                                        </div>
                                    </div>
                                </div>
