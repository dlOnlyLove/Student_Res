...
<head>
    ...
    <link href="../../css/pages/adminresetusrpwd.css" rel="stylesheet" />
            ...
            <div class="page-header">
                <div class="pull-left">
                    <ol class="breadcrumb visible-sm visible-md visible-lg">
                        ...
                        <li class="active"><i class="fa fa-laptop"></i>用户密码重置</li>
                    </ol>
                </div>
                                    ...
                                    <div class="bk-bg-white bk-padding-top-10 bk-padding-bottom-10">
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="account" class="form-control" id="account" placeholder="用户名" required/>
                                            </div>
                                            <div class="form-group">
...
<!-- Pages JS -->
<script src="../../js/pages/adminresetusrpwd.js"></script>
