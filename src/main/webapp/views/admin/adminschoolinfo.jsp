            ...
            <div class="page-header">
                <div class="pull-left">
                    <ol class="breadcrumb visible-sm visible-md visible-lg">
                        ...
                        <li><a><i class="icon fa fa-home"></i>信息管理</a></li>
                        <li class="active"><i class="fa fa-laptop"></i>教务人员信息</li>
                    </ol>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="panel panel-default bk-bg-white">
                        <div class="panel-heading bk-bg-white">
                            <h6><i class="fa fa-table red"></i><span class="break"></span>教务人员信息表</h6>
                            ...
                            <table class="table table-bordered table-striped" id="datatable-default">
                                ...
                                <c:forEach items="${schools }" var="school">
                                    <tr>
                                        ...
                                        <td>${school.name }</td>
                                        <td>${school.sex }</td>
                                        <td class="center hidden-phone">${school.tel }</td>
                                        <td class="center hidden-phone">${school.email }</td>
                                        <td>${school.school }</td>
                                        <td>${school.address }</td>                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                        </div>
...
<!-- Pages JS -->
<script src="../../js/pages/adminschoolinfo.js"></script>
