...
<head>
    ...
    <link href="../../css/pages/adminschoolres.css" rel="stylesheet" />
...
<div class="container-fluid content">
    <div class="row">
        ...
        <div class="main sidebar-minified">
            ...
            <div class="page-header">
                <div class="pull-left">
                    <ol class="breadcrumb visible-sm visible-md visible-lg">
                        ...
                        <li class="active"><i class="fa fa-laptop"></i>教务人员注册</li>
                    </ol>
                </div>
            ...
            <!-- End Page Header -->
            <!-- Form -->
            <div class="col-lg-7 col-md-7 col-sm-7 res">
                <div class="panel">
                    <div class="panel-body">
                        <form action="schoolResAction" class="form-horizontal" method="post">
                            <div class="bk-bg-white bk-padding-top-10 bk-padding-bottom-10">
                                <fieldset>
                                    <div class="form-group">
                                        <label for="Account">用户名</label>
                                        <input type="text" name="account" class="form-control" id="Account" placeholder="输入用户名" required/>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="profileLastName">性别</label>
                                    ...
                                    <div class="form-group">
                                        <label for="profileLastName">联系电话</label>
                                        <input type="text" name="tel" class="form-control" id="profileLastName" placeholder="输入联系电话" required/>
                                    </div>
                                    <div class="form-group">
                                        <label for="profileAddress">邮箱</label>
                                        <input type="email" name="email" class="form-control" id="profileEmail" placeholder="输入邮箱" required/>
                                    </div>
                                    <div class="form-group">
                                        <label for="profileCompany">学校</label>
                                        <input type="text" name="school" class="form-control" id="profileCompany" placeholder="输入学校" required/>
                                    </div>
                                    <div class="form-group">
                                        <label for="profileCompany">地址</label>
                                        <input type="text" name="address" class="form-control" id="profileAddress" placeholder="输入地址" />
                                    </div>
                                </fieldset>
...
<!-- Pages JS -->
<script src="../../js/pages/adminschoolres.js" ></script>
<!-- end: JavaScript-->
